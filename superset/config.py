...
#     "rel": "icon"
# },
FAVICONS = [{"href": "/static/assets/images/edrak/favicon.png"}]
...
# Default value of None will take you to '/edrak/welcome'
# You can also specify a relative URL e.g. '/edrak/welcome' or '/dashboards/list'
